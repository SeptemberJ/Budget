<template>
  <div class="BudgetDetail" v-loading="loading">
    ...
    <table id="budget" cellspacing="0" class="MarginB_20" style="width: 100%;border-top: 1px solid #DCDFE6;border-left: 1px solid #DCDFE6;">
      ...
      <tbody>
        ...
        <tr class="FontBold">
          ...
          <td><el-input v-model="note['1001']" size="small"></el-input></td>
        </tr>
        <tr @dblclick="seeDetail(0)">
          ...
          <td><el-input v-model="note['100101']" size="small"></el-input></td>
        </tr>
        <tr @dblclick="seeDetail(0)">
          <td></td>
          <td>1001.02</td>
          ...
          <td><el-input v-model="note['100102']" size="small"></el-input></td>
        </tr>
        <tr @dblclick="seeDetail(0)">
          <td></td>
          <td>1001.03</td>
          ...
          <td><el-input v-model="note['100103']" size="small"></el-input></td>
        </tr>
        <!-- line2 -->
        <tr class="FontBold">
          <td>2</td>
        ...
        <tr class="FontBold">
          ...
          <td>1501</td>
          <td>税费</td>
          <td>{{Number(formBudget.rate == 'C' ? (((Number(budget['1001']) - Number(budget['1201'])) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(budget['1001']) - Number(budget['1201'])) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'A' ? ((Number(budget['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(budget['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'B' ? ((Number(budget['1001']) / 1.09 * 0.09 - Number(budget['1201']) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(budget['1001']) / 1.09 * 0.09 - Number(budget['1201']) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((formBudget.rate == 'A' ? ((Number(budget['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(budget['1001']) / 1.09 * 0.09 - Number(budget['1201']) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(budget['1001']) - Number(budget['1201'])) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (formBudget.rate == 'A' ? ((Number(budget['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(budget['1001']) / 1.09 * 0.09 - Number(budget['1201']) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(budget['1001']) - Number(budget['1201'])) / 1.13 * 0.13 - Number(budget['130102']) / 1.09 * 0.09 - Number(budget['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(budget['1001']) * rateCompany).toFixed(2)) + Number((Number(budget['1001']) * 0.0003).toFixed(2)) + Number((Number(budget['1001']) * rateManagement).toFixed(2))}}</td>
          <td>{{Number(formBudget.rate == 'C' ? (((Number(finalAccounts['1001']) - Number(finalAccounts['1201'])) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(finalAccounts['1001']) - Number(finalAccounts['1201'])) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'A' ? ((Number(finalAccounts['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(finalAccounts['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'B' ? ((Number(finalAccounts['1001']) / 1.09 * 0.09 - Number(finalAccounts['1201']) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(finalAccounts['1001']) / 1.09 * 0.09 - Number(finalAccounts['1201']) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((formBudget.rate == 'A' ? ((Number(finalAccounts['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(finalAccounts['1001']) / 1.09 * 0.09 - Number(finalAccounts['1201']) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(finalAccounts['1001']) - Number(finalAccounts['1201'])) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (formBudget.rate == 'A' ? ((Number(finalAccounts['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(finalAccounts['1001']) / 1.09 * 0.09 - Number(finalAccounts['1201']) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(finalAccounts['1001']) - Number(finalAccounts['1201'])) / 1.13 * 0.13 - Number(finalAccounts['130102']) / 1.09 * 0.09 - Number(finalAccounts['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(finalAccounts['1001']) * rateCompany).toFixed(2)) + Number((Number(finalAccounts['1001']) * 0.0003).toFixed(2)) + Number((Number(finalAccounts['1001']) * rateManagement).toFixed(2))}}</td>
          <td>{{Number(formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(financialData['1001']) * rateCompany).toFixed(2)) + Number((Number(financialData['1001']) * 0.0003).toFixed(2)) + Number((Number(financialData['1001']) * rateManagement).toFixed(2))}}</td>
          <td>{{note['1501']}}</td>
        </tr>
        <tr v-if="ifShow">
          <td></td>
        ...
        <tr>
          ...
          <td>{{(Number(financialData['1001']) - Number(financialData['1201']) - Number(financialData['1301']) - Number(financialData['1401']) - Number(Number(formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(financialData['1001']) * rateCompany).toFixed(2)) + Number((Number(financialData['1001']) * 0.0003).toFixed(2)) + Number((Number(financialData['1001']) * rateManagement).toFixed(2)))).toFixed(2)}}</td>
        ...
        <tr>
          ...
          <td>{{!Number(financialData['1001']) ? 0 : (((Number(financialData['1001']) - Number(financialData['1201']) - Number(financialData['1301']) - Number(financialData['1401']) - Number(Number(formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (formBudget.rate == 'A' ? ((Number(financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'B' ? ((Number(financialData['1001']) / 1.09 * 0.09 - Number(financialData['1201']) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (formBudget.rate == 'C' ? (((Number(financialData['1001']) - Number(financialData['1201'])) / 1.13 * 0.13 - Number(financialData['130102']) / 1.09 * 0.09 - Number(financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(financialData['1001']) * rateCompany).toFixed(2)) + Number((Number(financialData['1001']) * 0.0003).toFixed(2)) + Number((Number(financialData['1001']) * rateManagement).toFixed(2)))).toFixed(2)) / Number(financialData['1001']) * 100).toFixed(2)}}%</td>
    ...
    <el-dialog
      ...
      fullscreen>
      <Fee v-if="detailType == 0" :projectName="formBudget.projectName"/>
      <!-- 成本 -->
      <Cost v-if="detailType == 1" :projectName="formBudget.projectName" :parameter="parameter"/>
      <!-- 费用 -->
      <Outlay v-if="detailType == 2" :projectName="formBudget.projectName" :parameter="parameter"/>
        ...
        if (valid) {
          ...
          let botData = {'items': [
            ...
            },
            {
              ...
              '1701.13': (Number(this.financialData['1001']) * 0.04).toFixed(2),
              '1701.14': (Number(this.financialData['1001']) * 0.0003).toFixed(2),
              '1701.15': (Number(this.financialData['1001']) * 0.04).toFixed(2),
              '1801': !Number(this.financialData['1001']) ? 0 : (((Number(this.financialData['1001']) - Number(this.financialData['1201']) - Number(this.financialData['1301']) - Number(this.financialData['1401']) - Number(Number(this.formBudget.rate === 'C' ? (((Number(this.financialData['1001']) - Number(this.financialData['1201'])) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? ((Number(this.financialData['1001']) - Number(this.financialData['1201'])) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(this.formBudget.rate === 'A' ? ((Number(this.financialData['1001']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(this.financialData['1001']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number(this.formBudget.rate === 'B' ? ((Number(this.financialData['1001']) / 1.09 * 0.09 - Number(this.financialData['1201']) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2) > 0 ? (Number(this.financialData['1001']) / 1.09 * 0.09 - Number(this.financialData['1201']) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2) : 0) : 0) + Number((this.formBudget.rate === 'A' ? ((Number(this.financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (this.formBudget.rate === 'B' ? ((Number(this.financialData['1001']) / 1.09 * 0.09 - Number(this.financialData['1201']) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (this.formBudget.rate === 'C' ? (((Number(this.financialData['1001']) - Number(this.financialData['1201'])) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))) > 0 ? (this.formBudget.rate === 'A' ? ((Number(this.financialData['1001']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (this.formBudget.rate === 'B' ? ((Number(this.financialData['1001']) / 1.09 * 0.09 - Number(this.financialData['1201']) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : (this.formBudget.rate === 'C' ? (((Number(this.financialData['1001']) - Number(this.financialData['1201'])) / 1.13 * 0.13 - Number(this.financialData['130102']) / 1.09 * 0.09 - Number(this.financialData['130103']) / 1.03 * 0.03).toFixed(2)) * 0.1 : 0))).toFixed(2) : 0) + Number((Number(this.financialData['1001']) * this.rateCompany).toFixed(2)) + Number((Number(this.financialData['1001']) * 0.0003).toFixed(2)) + Number((Number(this.financialData['1001']) * this.rateManagement).toFixed(2)))).toFixed(2)) / Number(this.financialData['1001']) * 1).toFixed(2)
            }
          ]}
          let noteData = {'items': [
            {
      ...
      this.Http.post('JA_LIST', tmpData
        ...
        if (Info.length > 0) {
          ...
          this.budget = {
            ...
            '100103': Info[0]['1001.02'] > 0 ? Info[0]['1001.02'] : '',
            '1201': '',
